...
Tested with Wordpress 7.0 , WooCommerce version 10.9.4
...
= 1.2.6 =
* Fixed: Resolve issues in pending refund related order note
* Fixed: Resolve issues in refund error popup message

= 1.2.5 =
* Updated: WooCommerce and WordPress support version
* Added: Support New UnionPay UPOP refund notification

= 1.2.4 =
* Updated: WooCommerce and WordPress support version
* Fixed: Resolve issues in void transaction status

= 1.2.3 =
* Fixed: Resolve issues in return url sign verification
* Fixed: Resolve issues in refund transaction
...
= 1.2.0 =
* Fixed: Plugin main file name and data sanitization
...
= 1.1.7 =
* Added: Support WooCommerce 8.1 and High-Performance Order Storage (HPOS)
* Fixed: Resolve issues in non-numeric characters from phone number

= 1.1.6 =
* Fixed: Resolve issues in partial refund with parameters
...
* Fixed: Resolve issues in billing information setting
...
= 1.1.2 =
* Added: Support checkout domain key
* Added: Payment method logo option

= 1.1.1 =
* Fixed: Resolve minor issues in metadata

= 1.1.0 =
* Added: Support Credit Card Online Gateway
* Added: Support order id prefix
* Added: Checkout page payment method icon base on gateway setting
* Added: Support partial refund
* Fixed: Resolve issues in getting order currency method

= 1.0.9 =
* Fixed: Resolve issues in error handling

= 1.0.8 =
* Fixed: Resolve issues in icon size

= 1.0.7 =
* Updated: WooCommerce and WordPress support version
* Fixed: Resolve issues in thankyou page sign verification

= 1.0.6 =
* Fixed: UnionPay ExpressPay and UPOP setting

= 1.0.5 =
* Added: Support UnionPay
* Added: Support Chinese locales
* Updated: Support WooCommerce 4.0
* Updated: Documentation

= 1.0.4 =
* Fixed: Resolve issues in sign verification
