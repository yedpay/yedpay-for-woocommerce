...
5. A page with the QR code will show out, users can scan the QR code with the Alipay or WeChat App
6. Payment successful page
...
* Updated: Support WooCommerce 4.0 or above
